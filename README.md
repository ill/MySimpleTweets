# Project 4 - *Simple Tweets Part 2*
...
<img src='https://github.com/ill/MySimpleTweets/blob/master/Recording_2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Refactoring the code to not be in MainTimeLine activity but in the fragment took some time.
Once I got it done it was very easy to create subclasses of the main tweet list fragment and just call the right api to get other timelines.  The base class handles all of the infinite scrolling and paging and displaying of the tweets themselves.
